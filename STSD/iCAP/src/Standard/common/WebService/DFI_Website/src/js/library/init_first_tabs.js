...
export var putFirstsTabs = function (deviceInfo, clickFlag, event_table, oobDirector) {
    ...
    var forward = $Tab("", 'fa fa-chevron-circle-left', 'padding: 12px 10px;').getTab();
    var next = $Tab("", 'fa fa-chevron-circle-right', 'padding: 12px 10px; margin-right:12px').getTab();
    var iAnalyzer = $Tab("iAnalyzer", "fa fa-hdd-o").getTab();
    var refresh = $Tab("Refresh", "fa fa-refresh").getTab();
    ...
    put([iAnalyzer, refresh], tab_primary_container);
    //-----------------------------------------------------------------------------------------
