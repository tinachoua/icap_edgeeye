    ...
    $document.on("reload-dashboard", () => {
        ...
        var initHome = function (response, data, xhr) {
            ...
            dashboardList.forEach((element, index) => {
                var tb = $Tab(element.Name).getTab();
                ...
                if (index === 0) {
                    ...
                    tb.style.color = "rgb(109, 153, 152)";
                }
                tb.value = element.Id;
                ...
                tb.addEventListener("click", function (e) {
                    ...
                    $('#tab-primary-continer > a ').each((idx, tab) => {
                        ...
                        tab.style.color = "rgb(109, 153, 152)";
                    });
            ...
            tab_container.appendChild(tabFragment);
                ...
                $dashboardLayout.sortable({
                    ...
                    update: function () {
                        ...
                        var saveWidgetOrder = function (widgetOrder) {
                            ...
                            promise = APIActor.POST("/DashboardAPI/Order", payloadObj);
                            promise.done(() => {
                                var newg_OutChart = [];
