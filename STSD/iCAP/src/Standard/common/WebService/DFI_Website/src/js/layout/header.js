// import imgicaplogo2 from "../../assets/images/iCAPlogo2.png";
// import imginnologo from "../../assets/images/logo-innodisk.png";
// import imgicaplogo from "../../assets/images/logo-icap.png";
...
$(document).on("reload-header", function () {
    ...
    var icaplogo = document.getElementById("logo");
    ...
    $("#logo").bind("click", SWITCH.ToDashboard);
